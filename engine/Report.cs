...
namespace Wasteland 
{
	public class Report 
	{
		...
		{
			Write(line, true, true);
		}

		private static void Write(string line, bool indent, bool langs) 
		{
			...
			{
				int j = 71;
				while (line.Length > j && j >= 0 && line[j] != ' ') j--;
