...
namespace Wasteland
{
	...
	class ItemType 
	{
		...
		public static ItemTypeArrayList List = new ItemTypeArrayList();
		...
		// Man
    public ItemTypeArrayList Food = new ItemTypeArrayList();
		...
		public ItemArrayList Drops = new ItemArrayList();

		// Baby
		public ItemTypeArrayList GrowTo = new ItemTypeArrayList();
	...
	class ItemTypeArrayList : ArrayList 
	{
